...
class PublicationTypeModel(BaseModel):
    ...
    id = UUIDColumn()
    name = Column(String)file:///home/x-code/Documents/hacking_days/_uois_hacking_days/config_changes/facilities/DBDefinitions(1).py
...
def ComposeConnectionString():
    ...
    hostWithPort = os.environ.get("POSTGRES_HOST", "postgres:5438")
    hostWithPort = os.environ.get("POSTGRES_HOST", "host.docker.internal:5438")
